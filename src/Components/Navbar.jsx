  ...
  return (
    <div className="bg-purple-500">
        <div className='max-w-7xl mx-auto px-3 text-white shadow-lg flex justify-between'>
            ...
            <ul className={`flex flex-col md:flex-row items-start md:items-center justify-center absolute left-0 md:static w-full md:w-auto transition-all duration-500 ease-in ${open ? 'opacity-100 top-20': 'opacity-0 md:opacity-100 top-[-500px] z-[-1]'} z-[-1] md:z-auto`}>
